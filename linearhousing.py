...
coreml_model = coremltools.converters.statsmodels\
    .convert(fitted_statsmodel_model, ["Bedrooms", "Bathrooms", "Size"], "Price")

# Print statsmodels prediction
print "\nSTATSMODELS PREDICTION (2 Bathrooms, 4 Bedrooms, 2000 SQ. Feet) \n"\
